...
class FirefoxMobilePage(FirefoxBasePage):
    ...
    _get_firefox_qr_code_locator = (By.CSS_SELECTOR, '.desktop-download.firefox .qr-code-wrapper img')
    ...
    _get_focus_qr_code_locator = (By.CSS_SELECTOR, '.desktop-download.focus .qr-code-wrapper img')
