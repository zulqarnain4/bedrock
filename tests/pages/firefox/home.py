...
class FirefoxHomePage(FirefoxBasePage):
    ...
    _primary_download_button_locator = (By.CSS_SELECTOR, '.main-header-section .download-button')
    _secondary_download_button_locator = (By.CSS_SELECTOR, '.secondary-download-section .download-button')
