...
class ProductVersion(models.Model):
    ...
    def save(self, force_insert=False, force_update=False,
        ...
        super(ProductVersion, self).save(force_insert, force_update,
                                         using, update_fields)
...
class SecurityAdvisory(models.Model):
    ...
    fixed_in = models.ManyToManyField(ProductVersion, related_name='advisories')
    products = models.ManyToManyField(Product, related_name='advisories')
