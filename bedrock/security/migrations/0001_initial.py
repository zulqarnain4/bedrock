...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'security_productversion', (
        ...
        db.send_create_signal(u'security', ['ProductVersion'])
        ...
        db.create_table(m2m_table_name, (
            ...
            ('productversion', models.ForeignKey(orm[u'security.productversion'], null=False))
        ))
        db.create_unique(m2m_table_name, ['securityadvisory_id', 'productversion_id'])

        # Adding M2M table for field products on 'SecurityAdvisory'
        m2m_table_name = db.shorten_name(u'security_securityadvisory_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('securityadvisory', models.ForeignKey(orm[u'security.securityadvisory'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'security_productversion')
        ...
        # Removing M2M table for field products on 'SecurityAdvisory'
        db.delete_table(db.shorten_name(u'security_securityadvisory_products'))
    ...
    models = {
        ...
        u'security.productversion': {
            'Meta': {'ordering': "('slug',)", 'object_name': 'ProductVersion'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'security.securityadvisory': {
            ...
            'fixed_in': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'advisories'", 'symmetrical': 'False', 'to': u"orm['security.ProductVersion']"}),
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'advisories'", 'symmetrical': 'False', 'to': u"orm['security.Product']"}),
